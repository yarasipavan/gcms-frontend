      ...
      <div className=" sidebar d-flex  flex-column bg-dark text-white p-4 vh-100">
        <div>
          <a className="d-flex align-items-center text-white">
            ...
            <span className="fs-4 d-none d-lg-inline">Gated Community</span>
          </a>
          {!user.isfirstlogin && (
            <div>
                  ...
                  <>
                    ...
                    <li className="nav-item p-1">
                      <NavLink to="flats" className="nav-link text-white">
                        ...
                        <span className="fs-5 d-none d-lg-inline">Flats</span>
                      </NavLink>
                    </li>
                    <li className="nav-item p-1">
                      <NavLink to="owners" className="nav-link text-white">
                        <i className="bi bi-person-fill me-2 fs-5"></i>
                        <span className="fs-5 d-none d-lg-inline">Owners</span>
                      </NavLink>
                    </li>
                    <li className="nav-item p-1">
                    ...
                    <li className="nav-item p-1">
                      <NavLink to="bills" className="nav-link text-white">
                        <FontAwesomeIcon
                          ...
                          className="me-2 fs-5"
                        />
                        <span className="fs-5 d-none d-lg-inline"> Bills</span>
                      </NavLink>
                    </li>
                    <li className="nav-item p-1">
                      <NavLink
